...
import { Dumbbell, Mail, Lock, Eye, EyeOff, ArrowRight, Loader2, User } from 'lucide-react'
    ...
    return (
        <div className="min-h-screen bg-black flex items-center justify-center relative overflow-hidden px-4">
            ...
            <div className="absolute inset-0 pointer-events-none">
                <div className="absolute top-[-300px] left-[-200px] w-[600px] h-[600px] rounded-full opacity-15"
                    style={{ background: 'radial-gradient(circle, #8B5CF6 0%, transparent 70%)' }} />
                <div className="absolute bottom-[-250px] right-[-200px] w-[600px] h-[600px] rounded-full opacity-15"
            ...
            >
                ...
                <motion.form
                    ...
                    className="glass-card-solid p-8 space-y-5"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
